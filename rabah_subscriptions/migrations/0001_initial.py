    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscription_duration', models.CharField(blank=True, choices=[('14_DAYS_TRIAL', '14_DAYS_TRIAL'), ('MONTHLY', 'MONTHLY'), ('QUARTERLY', 'QUARTERLY'), ('YEARLY', 'YEARLY')], max_length=250, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organisation', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='rabah_organisations.organisation')),
