...
class BillingAddressAdmin(admin.ModelAdmin):
    list_display = (
    'organisation', 'address', 'city', 'state', 'country', 'zip_code', 'is_billing_verified', 'is_card_verified',
    'timestamp')
    search_fields = ('organisation__name', 'address', 'city', 'state', 'country', 'zip_code')
...
class TransactionAdmin(admin.ModelAdmin):
    list_display = (
    'organisation', 'created_by', 'member', 'method', 'transaction_id', 'description', 'status', 'amount', 'timestamp')
    search_fields = (
    'organisation__name', 'created_by__username', 'member__username', 'method', 'transaction_id', 'description',
    'status')
