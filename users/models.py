...
class UserProfile(models.Model):
    ...
    profile_image = models.ImageField(upload_to="profile_image", default="profile_image.png")
    ...
    marital_status = models.CharField(max_length=50, blank=True, null=True, choices=MARITAL_STATUS_CHOICES)
