...
class EventManager(models.Manager):
    def calculate_event_increment_percentage(self, organisation_id):
        ...
        current_month_count = Event.objects.filter(
...
class Event(models.Model):
    ...
    repeat = models.CharField(
        max_length=250, blank=True, null=True, choices=REPEAT_CHOICES
    )
    repeat_end = models.CharField(
        max_length=250, blank=True, null=True, choices=REPEAT_END_CHOICES
    )
