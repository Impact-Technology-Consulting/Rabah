...
urlpatterns = [
    ...
    path('organisations/', include('rabah_organisations.urls'), name="rabah_organisations"),
    path('member/', include('rabah_members.urls'), name="rabah_members"),
    path('rabah_contributions/', include('rabah_contributions.urls'), name="rabah_contributions"),
    path('event/', include('rabah_events.urls'), name="rabah_events"),
    path('subscription/', include('rabah_subscriptions.urls'), name="rabah_subscriptions"),
