...
from .views import MembersDashboardView, GroupMembersView, MemberDetailView, MemberCreateView, \
    ...
    UpdateExistingMemberFamilyRelationShipView, MemberUploadCreateView, MemberAddLoginPermissionView
...
urlpatterns = [
    ...
    # member update
    path("member_login_premission/<str:member_id>/", MemberAddLoginPermissionView.as_view(),
